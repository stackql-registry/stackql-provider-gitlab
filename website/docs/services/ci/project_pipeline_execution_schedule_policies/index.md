--- 
title: project_pipeline_execution_schedule_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - project_pipeline_execution_schedule_policies
  - ci
  - gitlab
...
Gets or lists a <code>project_pipeline_execution_schedule_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="project_pipeline_execution_schedule_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="gitlab.ci.project_pipeline_execution_schedule_policies" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="policy_blob_file_path" /></td>
    <td><code>string</code></td>
    <td>Path to the policy file in the project.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Pipeline Execution Schedule Policies of the namespace. Generated from the GitLab GraphQL schema field Project.pipelineExecutionSchedulePolicies (connection of PipelineExecutionSchedulePolicy nodes).</td>
</tr>
</tbody>
</table>
...
Pipeline Execution Schedule Policies of the namespace. Generated from the GitLab GraphQL schema field Project.pipelineExecutionSchedulePolicies (connection of PipelineExecutionSchedulePolicy nodes).
...
warnings,
yaml
FROM gitlab.ci.project_pipeline_execution_schedule_policies
