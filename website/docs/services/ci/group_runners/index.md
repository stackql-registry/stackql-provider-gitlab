...
Gets or lists a <code>group_runners</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="group_runners" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="gitlab.ci.group_runners" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-creator_id"><code>creator_id</code></a>, <a href="#parameter-creator_username"><code>creator_username</code></a>, <a href="#parameter-membership"><code>membership</code></a>, <a href="#parameter-paused"><code>paused</code></a>, <a href="#parameter-search"><code>search</code></a>, <a href="#parameter-sort"><code>sort</code></a>, <a href="#parameter-status"><code>status</code></a>, <a href="#parameter-type"><code>type</code></a>, <a href="#parameter-upgrade_status"><code>upgrade_status</code></a>, <a href="#parameter-version_prefix"><code>version_prefix</code></a></td>
    <td>Find runners visible to the current user. Generated from the GitLab GraphQL schema field Group.runners (connection of CiRunner nodes).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-membership">
    ...
    <td><code>string</code></td>
    <td>Control which runners to include in the results.</td>
</tr>
...
Find runners visible to the current user. Generated from the GitLab GraphQL schema field Group.runners (connection of CiRunner nodes).
