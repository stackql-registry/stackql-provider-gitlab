...
Gets or lists a <code>project_jobs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="project_jobs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="gitlab.ci.project_jobs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-kind"><code>kind</code></a>, <a href="#parameter-pipeline_iid"><code>pipeline_iid</code></a>, <a href="#parameter-with_artifacts"><code>with_artifacts</code></a></td>
    <td>Jobs of a project. This field can only be resolved for one project in any single request. Generated from the GitLab GraphQL schema field Project.jobs (connection of CiJob nodes).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-kind">
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Filter jobs by kind.</td>
</tr>
<tr id="parameter-pipeline_iid">
    <td><CopyableCode code="pipeline_iid" /></td>
    <td><code>string</code></td>
    <td>Filter jobs by the internal pipeline ID (iid).</td>
</tr>
<tr id="parameter-with_artifacts">
    <td><CopyableCode code="with_artifacts" /></td>
    <td><code>boolean</code></td>
    <td>Filter by artifacts presence.</td>
</tr>
</tbody>
</table>
...
Jobs of a project. This field can only be resolved for one project in any single request. Generated from the GitLab GraphQL schema field Project.jobs (connection of CiJob nodes).
...
AND kind = '{{ kind }}'
AND pipeline_iid = '{{ pipeline_iid }}'
AND with_artifacts = '{{ with_artifacts }}'
;
```
</TabItem>
</Tabs>
