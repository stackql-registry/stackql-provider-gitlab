...
Gets or lists a <code>group_projects</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="group_projects" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="gitlab.groups.group_projects" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-archived_only"><code>archived_only</code></a>, <a href="#parameter-has_code_coverage"><code>has_code_coverage</code></a>, <a href="#parameter-has_vulnerabilities"><code>has_vulnerabilities</code></a>, <a href="#parameter-include_archived"><code>include_archived</code></a>, <a href="#parameter-include_subgroups"><code>include_subgroups</code></a>, <a href="#parameter-not_aimed_for_deletion"><code>not_aimed_for_deletion</code></a>, <a href="#parameter-sbom_component_id"><code>sbom_component_id</code></a>, <a href="#parameter-search"><code>search</code></a>, <a href="#parameter-sort"><code>sort</code></a>, <a href="#parameter-with_issues_enabled"><code>with_issues_enabled</code></a>, <a href="#parameter-with_merge_requests_enabled"><code>with_merge_requests_enabled</code></a>, <a href="#parameter-with_namespace_domain_pages"><code>with_namespace_domain_pages</code></a></td>
    <td>Projects within this namespace. Returns projects from the parent group if namespace is project. Generated from the GitLab GraphQL schema field Group.projects (connection of Project nodes).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-archived_only">
    <td><CopyableCode code="archived_only" /></td>
    <td><code>boolean</code></td>
    <td>Return only archived projects.</td>
</tr>
<tr id="parameter-has_code_coverage">
    <td><CopyableCode code="has_code_coverage" /></td>
    <td><code>boolean</code></td>
    <td>Returns only the projects which have code coverage.</td>
</tr>
<tr id="parameter-has_vulnerabilities">
    <td><CopyableCode code="has_vulnerabilities" /></td>
    <td><code>boolean</code></td>
    <td>Returns only the projects which have vulnerabilities.</td>
</tr>
<tr id="parameter-include_archived">
    <td><CopyableCode code="include_archived" /></td>
    <td><code>boolean</code></td>
    <td>Include also archived projects.</td>
</tr>
<tr id="parameter-include_subgroups">
    <td><CopyableCode code="include_subgroups" /></td>
    <td><code>boolean</code></td>
    <td>Include also subgroup projects.</td>
</tr>
<tr id="parameter-not_aimed_for_deletion">
    <td><CopyableCode code="not_aimed_for_deletion" /></td>
    <td><code>boolean</code></td>
    <td>Include projects that are not aimed for deletion.</td>
</tr>
<tr id="parameter-sbom_component_id">
    <td><CopyableCode code="sbom_component_id" /></td>
    <td><code>string</code></td>
    <td>Return only the projects related to the specified SBOM component.</td>
</tr>
<tr id="parameter-search">
    <td><CopyableCode code="search" /></td>
    <td><code>string</code></td>
    <td>Search project with most similar names or paths.</td>
</tr>
<tr id="parameter-sort">
    <td><CopyableCode code="sort" /></td>
    <td><code>string</code></td>
    <td>Sort projects by the criteria.</td>
</tr>
...
<tr id="parameter-with_namespace_domain_pages">
    <td><CopyableCode code="with_namespace_domain_pages" /></td>
    <td><code>boolean</code></td>
    <td>Return only projects that use the namespace domain for pages projects.</td>
</tr>
</tbody>
</table>
...
Projects within this namespace. Returns projects from the parent group if namespace is project. Generated from the GitLab GraphQL schema field Group.projects (connection of Project nodes).
...
AND archived_only = '{{ archived_only }}'
AND has_code_coverage = '{{ has_code_coverage }}'
