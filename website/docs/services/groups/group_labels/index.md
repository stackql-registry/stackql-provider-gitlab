...
Gets or lists a <code>group_labels</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="group_labels" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="gitlab.groups.group_labels" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-archived"><code>archived</code></a>, <a href="#parameter-include_ancestor_groups"><code>include_ancestor_groups</code></a>, <a href="#parameter-include_descendant_groups"><code>include_descendant_groups</code></a>, <a href="#parameter-only_group_labels"><code>only_group_labels</code></a>, <a href="#parameter-search_term"><code>search_term</code></a>, <a href="#parameter-title"><code>title</code></a></td>
    <td>Labels available on this group. Generated from the GitLab GraphQL schema field Group.labels (connection of Label nodes).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-include_descendant_groups">
    <td><CopyableCode code="include_descendant_groups" /></td>
    <td><code>boolean</code></td>
    <td>Include labels from descendant groups.</td>
</tr>
<tr id="parameter-only_group_labels">
    <td><CopyableCode code="only_group_labels" /></td>
    <td><code>boolean</code></td>
    <td>Include only group level labels.</td>
</tr>
...
Labels available on this group. Generated from the GitLab GraphQL schema field Group.labels (connection of Label nodes).
...
title,
updated_at
FROM gitlab.groups.group_labels
WHERE full_path = '{{ full_path }}' -- required
AND host = '{{ host }}' -- required (defaults to gitlab.com; or set GITLAB_HOST)
AND archived = '{{ archived }}'
AND include_ancestor_groups = '{{ include_ancestor_groups }}'
AND include_descendant_groups = '{{ include_descendant_groups }}'
AND only_group_labels = '{{ only_group_labels }}'
