--- 
title: project_security_policy_project_suggestions
hide_title: false
hide_table_of_contents: false
keywords:
  - project_security_policy_project_suggestions
  - security
  - gitlab
...
Gets or lists a <code>project_security_policy_project_suggestions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="project_security_policy_project_suggestions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="gitlab.security.project_security_policy_project_suggestions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-full_path"><code>full_path</code></a>, <a href="#parameter-search"><code>search</code></a>, <a href="#parameter-host"><code>host</code></a></td>
    <td><a href="#parameter-only_linked"><code>only_linked</code></a></td>
    <td>Security policy project suggestions Generated from the GitLab GraphQL schema field Project.securityPolicyProjectSuggestions (connection of Project nodes).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-search">
    ...
    <td><code>string</code></td>
    <td>Search query for projects' full paths.</td>
</tr>
<tr id="parameter-only_linked">
    <td><CopyableCode code="only_linked" /></td>
    <td><code>boolean</code></td>
    <td>Whether to suggest only projects already linked as security policy projects.</td>
</tr>
</tbody>
</table>
...
Security policy project suggestions Generated from the GitLab GraphQL schema field Project.securityPolicyProjectSuggestions (connection of Project nodes).
...
web_url,
wiki_enabled
FROM gitlab.security.project_security_policy_project_suggestions
WHERE full_path = '{{ full_path }}' -- required
AND search = '{{ search }}' -- required
AND host = '{{ host }}' -- required (defaults to gitlab.com; or set GITLAB_HOST)
AND only_linked = '{{ only_linked }}'
;
```
</TabItem>
</Tabs>
